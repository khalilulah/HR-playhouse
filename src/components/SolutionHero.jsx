...
function SolutionHero() {
  ...
  return (
    <div className="mx-auto  py-0 max-w-400 h-[calc(100vh-3.8rem)] sm:h-[calc(100vh-4rem)] md:h-[calc(100vh-5rem)] flex justify-center flex-col xl:flex-row gap-8 lg:gap-12 xl:gap-16 items-center px-4 sm:px-6 lg:px-8 perspective-[1500px] pb-[2rem] md:pb-[2.5rem] overflow-hidden">
      {/* Text Section */}
      <div className="w-full xl:w-1/2 text-center  xl:text-left">
        ...
        <p
          className={`text-primary-text text-base sm:text-lg md:text-lg lg:text-xl leading-relaxed max-w-xl mx-auto xl:mx-0 transition-all duration-1000 ease-out delay-200 ${
            isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"
          }`}
        >
        ...
        <div className="relative w-full max-w-[280px] h-[280px] sm:max-w-[320px] sm:h-[320px] md:max-w-[380px] md:h-[380px] lg:max-w-[440px] lg:h-[440px] xl:max-w-[480px] xl:h-[480px]">
          ...
          <div
            className={`absolute top-0 left-0 w-[63%] sm:w-[58%] md:w-[60%] transition-all duration-1300 ease-out ${
              isLoaded
                ...
                : "-translate-x-240 -translate-y-40 rotate-90 "
            }`}
          ...
          <div
            className={`absolute bottom-0 right-0 w-[63%] sm:w-[58%] md:w-[60%] transition-all duration-1300 ease-out delay-150 ${
              isLoaded
                ? "translate-x-0 translate-y-0 rotate-0"
                : "translate-x-40 translate-y-10 rotate-90"
            }`}
